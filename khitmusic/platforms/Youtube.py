...
import config
from khitmusic import LOGGER
from khitmusic.utils.database import is_on_off
from khitmusic.utils.formatters import time_to_seconds, seconds_to_min
...
class YouTubeAPI:
    ...
    def _yt_dlp_call_with_fallback(self, action, opts):
        ...
        try:
            ...
            original_cookie_path = "khitmusic/assets/cookies.txt"
            if not os.path.exists(original_cookie_path):
                raise e

            temp_cookie_path = "khitmusic/assets/cookies_temp.txt"
