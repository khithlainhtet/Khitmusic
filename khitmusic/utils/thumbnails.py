...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        ...
        arial_font = ImageFont.truetype("khitmusic/assets/assets/font2.ttf", 30)
        regular_font = ImageFont.truetype("khitmusic/assets/assets/font.ttf", 30)
        title_font = ImageFont.truetype("khitmusic/assets/assets/font3.ttf", 45)
    except OSError:
    ...
    # 4. Icons
    icons_path = "khitmusic/assets/assets/play_icons.png"
