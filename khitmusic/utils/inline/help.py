...
def help_pannel(_, start: bool = False):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="ᴅᴇғᴇɴᴅᴇʀ", callback_data="help_category defender"),
        ],
    ]
...
def help_category_pannel(_, category):
    ...
    if category == "music":
        ...
        buttons = [
            [InlineKeyboardButton(text="ᴇᴅɪᴛ ᴅᴇғᴇɴᴅᴇʀ", callback_data="help_callback hb53 defender"), InlineKeyboardButton(text="ᴍᴇᴅɪᴀ ᴅᴇғᴇɴᴅᴇʀ", callback_data="help_callback hb54 defender")],
            [InlineKeyboardButton(text="ᴡʜɪᴛᴇʟɪsᴛ", callback_data="help_callback hb55 defender")],
        ]
